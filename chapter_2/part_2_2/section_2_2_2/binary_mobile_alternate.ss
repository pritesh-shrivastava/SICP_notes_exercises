...
(define (right-branch mobile)
  (cdr mobile) ;; cons left ( cons right '())
)
...
;; Changing the underlying representation of the binary mobile from a list to a cons-ed structure only 
;; needed a change in the selectors. Everything else wored fine!!